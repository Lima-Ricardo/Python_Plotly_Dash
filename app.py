...
df_data = pd.read_csv(r"C:\Users\rilim_rcalv72\Pandas\csv_para_o_plotly\supermarket_sales.csv")
...
app.layout = html.Div(children=[
        dbc.Row([
            ...
            dbc.Col([
                dbc.Card([
                    html.H2("R-DATA", style={"font-family": "Voltaire", "font-size":"50px", "margin-left": "20px"}),
                    html.Hr(),
                    html.H5("Cidades:"),
